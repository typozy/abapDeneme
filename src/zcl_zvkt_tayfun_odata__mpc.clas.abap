class ZCL_ZVKT_TAYFUN_ODATA__MPC definition
  public
...
public section.
  ...
  types:
         TS_TABLO1 type ZVKT_TAYFUN_S003 .
  types:
    TT_TABLO1 type standard table of TS_TABLO1 .
  types:
  ...
  types:
         TS_TABLO2 type ZVKT_TAYFUN_S004 .
  types:
    TT_TABLO2 type standard table of TS_TABLO2 .

  constants GC_TABLO1 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Tablo1' ##NO_TEXT.
  constants GC_TABLO2 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Tablo2' ##NO_TEXT.
...
private section.
  ...
  methods DEFINE_TABLO1
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_TABLO2
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZVKT_TAYFUN_ODATA__MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZVKT_TAYFUN_ODATA_01_SRV' ).
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Tablo1' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZVKT_TAYFUN_S003'
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Tablo2' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZVKT_TAYFUN_S004'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'Tablo2Set' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220420113323'.                  "#EC NOTEXT
